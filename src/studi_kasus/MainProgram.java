...
public class MainProgram {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("5. Hapus Semua Kota dan Jalur Antarkota");
        ...
        // program.createVertex(graph, "Cianjur");
        // program.createVertex(graph, "Purwakarta");
        // program.createVertex(graph, "Bandung");
        // program.createVertex(graph, "Subang");
        // program.createVertex(graph, "Majalengka");
        // program.createVertex(graph, "Sumedang");
        // program.createVertex(graph, "Tasikmalaya");

        // A = program.searchVertex(graph, "Cianjur");
        // B = program.searchVertex(graph, "Purwakarta");
        // C = program.searchVertex(graph, "Bandung");
        // D = program.searchVertex(graph, "Subang");
        // E = program.searchVertex(graph, "Majalengka");
        // F = program.searchVertex(graph, "Sumedang");
        // G = program.searchVertex(graph, "Tasikmalaya");

        // program.addEdge(A, C, 3);
        // program.addEdge(B, A, 2);
        // program.addEdge(C, B, 1);
        // program.addEdge(C, D, 2);
        // program.addEdge(D, B, 4);
        // program.addEdge(E, D, 3);
        // program.addEdge(E, F, 1);
        // program.addEdge(E, G, 5);
        // program.addEdge(F, G, 2);
